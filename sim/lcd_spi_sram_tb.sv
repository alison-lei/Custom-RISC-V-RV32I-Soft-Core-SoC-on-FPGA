...
module lcd_spi_sram_tb;
    ...
    logic spi_sram_sel;
    logic [17:0] buffer_base_addr;
    logic [15:0] sram_data;
    logic lcd_done, lcd_dc;
    ...
    // ----------------------------------------
    // FILL THIS IN — cpu write task
    // ----------------------------------------
    task cpu_write(input [17:0] addr, input [15:0] data);
    ...
    initial begin
        ...
        swap_bit = 0; cpu_done = 0;
        buffer_base_addr = 18'h0;
